...
void OLED_ShowChinese(u8 x,u8 y,u8 num,u8 size1,u8 mode)
{
	...
	{
		if(size1==12)
				{temp=Hzc1[num][i];}//调用12*12字体
		else if(size1==16)
				{temp=Hzc2[num][i];}//调用16*16字体
		else return;
		for(m=0;m<8;m++)
		{
			if(temp&0x01)OLED_DrawPoint(x,y,mode);
...
//	OLED_ShowChinese(32,10,0,16,1);
//	OLED_ShowChinese(50,10,1,16,1);
//	OLED_ShowChinese(68,10,2,16,1); 
//	OLED_ShowChinese(86,10,3,16,1);
//	OLED_ShowChinese(104,10,4,16,1);
//	OLED_ShowChinese(32,30,5,16,1);
//	OLED_ShowChinese(50,30,6,16,1);
//	OLED_ShowChinese(68,30,7,16,1);
//	OLED_ShowChinese(86,30,8,16,1);
//	OLED_ShowChinese(104,30,9,16,1);
	OLED_Refresh();
//	HAL_Delay(1000);
}
